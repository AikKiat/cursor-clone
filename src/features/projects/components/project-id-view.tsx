    ...
    return (
        <div className="h-full flex flex-col">
            <nav className="h-10 flex items-center bg-sidebar border-b">
                <Tab label="Preview" isActive={activeView === "preview"} onClick={() => { setActiveView("preview") }}></Tab>
                <Tab label="Editor" isActive={activeView === "editor"} onClick={() => { setActiveView("editor") }}></Tab>
            ...
            <div className="flex-1 relative">
                <div className={cn(
                    ...
                    <Allotment className="h-full w-full" defaultSizes={[DEFAULT_SIDEBAR_WIDTH, DEFAULT_MAIN_SIZE]}>
                        ...
                        <Allotment.Pane>
                            <EditorView projectId={projectId}></EditorView>
                        </Allotment.Pane>
                    </Allotment>
                </div>
                <div className={cn(
